"""Merge 5 already-ingested PLD/PAM sessions, normalize, and approve all."""
...
MERGED = PROJECT / "outputs" / "merged_5spk"

SESSIONS = ["0400", "0401", "0402", "0403", "0405"]
