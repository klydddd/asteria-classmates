"""Merge 10 already-ingested PLD/PAM sessions, normalize, and approve all."""
...
MERGED = PROJECT / "outputs" / "merged_10spk"

SESSIONS = ["0400", "0401", "0402", "0403", "0405", "0407", "0408", "0409", "0410", "0411"]
